   ...
   //final List<ChartData<Pakan,String>> seties;
    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        title: 
        Text('Diagram Rekap', style: subStyle.copyWith(color:Get.isDarkMode?Colors.white:Colors.black,),),
        bottomOpacity: 0.0,
        elevation: 0.0,
        centerTitle: true,
...
dataChart(){
  return Container(
    ...
    child: ListView.builder(
        ...
        for (int index = 0;index < _pakanControler.pakanList.length;
               index++) {
        ...
        return SfCartesianChart(
           title: ChartTitle(
                  ...
                  textStyle:subtitle.copyWith( color:Get.isDarkMode?Colors.white:Colors.black),
                   ...
                   series: <ChartSeries<Pakandata,String>>[
                     ColumnSeries<Pakandata, String>(
                        dataSource:dataPakan,
                        xValueMapper: (data, _) => data.xValue.toString(),
              ...
              series: <CircularSeries>[
                PieSeries<TernakData, String>(
                  ...
                  dataSource: <TernakData>[
                    TernakData('Babi Terjual', _pigController.jumJual.toString()),
                    TernakData('Babi Beli', _pigController.jumBeli.toString()),
                    TernakData('Babi Mati',_pigController.jumMati.toString()),
                    TernakData('Babi Lahir', _pigController.jumMasuk.toString()),
                   
                  ],
                  xValueMapper: (TernakData data, _) => data.xku,
                  yValueMapper: (TernakData data, _) => int.tryParse(data.yku)
                ),
              ]
            );
      }
